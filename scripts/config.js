...
// Path prefixes that are assets, not authored pages — never get a .html suffix.
 ...
 *
 * Query string / hash are preserved; the suffix applies to the path only.
 * Idempotent: an already-".html" page path is not doubled.
 *
